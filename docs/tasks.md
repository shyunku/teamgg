...
`#66, #76, #73, #74, #70, #71, #72, #65, #75, #42, #51, #50, #52, #49, #44, #45, #46, #47, #48`
...
| 66 | backend | 🟡 WIP | 2026-09-02 03:37 | #58, #59 | 오래된 경기 데이터 정리 | 최신 8개 패치를 보존하는 bounded delete를 구현하고 첫 100경기를 삭제했다. 46,471경기가 남아 있으며, PK join 최적화 후 운영 소규모 성능 검증부터 재개한다. |
