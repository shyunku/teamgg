...
`#76, #73, #74, #70, #71, #72, #65, #75, #42, #51, #50, #52, #49, #44, #45, #46, #47, #48`
...
| 73 | backend | 🟡 WIP | 2026-09-03 16:41 | #64 | 숙련도 numeric 직접 쓰기 | 운영 읽기·쓰기를 `masteries_numeric_v2`로 전환하고 실제 Riot 갱신 표본의 legacy mirror 행 수·checksum 일치를 확인했다. DataExplorer·숙련도 통계 loop의 관찰 기간 검증 후 완료한다. |
