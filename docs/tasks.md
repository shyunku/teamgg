...
`#74, #76, #70, #71, #72, #65, #75, #42, #51, #50, #52, #49, #44, #45, #46, #47, #48`
...
| 74 | backend | 🟡 WIP | 2026-09-03 20:08 | #73 | Legacy 숙련도 제거 | numeric 운영 경로를 최종 검증하고 런타임·trigger 의존성을 제거한 뒤, 사용자 승인에 따라 전체 백업 없이 기존 `masteries`를 삭제해 약 20~25GiB의 OS 공간을 회수한다. |
